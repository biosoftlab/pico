...
def deg_prediction(combi_or_single, drug_name_list):

    # combi_or_single = sys.argv[1]
    # drug_name_list = sys.argv[2:]
    drug_names = '_'.join(drug_name_list)[:31]
    ...
    if combi_or_single == 'combination':
